...
[[ $XDG_CONFIG_HOME/mpd/mpd_configuration.sh -ot $XDG_CONFIG_HOME/mpd/mpd.conf ]] && exit
...
#    '$XDG_CONFIG_HOME/mpd/mpd.conf_autogen.sh'
#    or
...
bind_to_address "$MPD_RUNTIME_DIR/mpd/socket"
